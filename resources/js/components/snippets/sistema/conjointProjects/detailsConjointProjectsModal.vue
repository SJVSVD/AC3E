        ...
        <div class="modal-wrapper">
          <div class="modal-container">
            <div class="modal-header pb-1" style="font-weight: bold; color: #444444;">
              <slot name="header">
                <label class="col-5 m-0" style="font-size: 17px;">Conjoint Project Details</label>
              </slot>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-6 m-0 fs-8 pb-1">
                      ...
                      <label v-if="project1.beginningDate != null" class="fw-normal" style="font-size: 14px;">{{ project1.beginningDate }}</label>
                      <label v-else class="fw-normal" style="font-size: 14px;">---</label>
                    </div>
                    <div class="col-6 m-0 fs-8 pb-1">
                      <label>Ending Date: </label>
                      <label v-if="project1.endingDate != null" class="fw-normal" style="font-size: 14px;">{{ project1.endingDate }}</label>
                      <label v-else class="fw-normal" style="font-size: 14px;">---</label>
                    </div>
                    <div class="col-6 m-0 fs-8 pb-1">
                    ...
                    <div class="col-6 m-0 fs-8 pb-1">
                      ...
                      <label v-if="project1.nameOfAC3EMember != null" class="fw-normal" style="font-size: 14px;">{{ project1.nameOfAC3EMember }}</label>
                      <label v-else class="fw-normal" style="font-size: 14px;">---</label>
                    </div>
                    <div class="col-6 m-0 fs-8 pb-1">
