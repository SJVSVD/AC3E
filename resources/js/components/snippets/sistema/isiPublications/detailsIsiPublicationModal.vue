          ...
          <div class="modal-wrapper">
            <div class="modal-container">
              <div class="modal-header pb-1" style="font-weight: bold; color: #444444;">
                <slot name="header">
                  <label class="col-5 m-0" style="font-size: 17px;">WoS Publication Details:</label>
                ...
                <slot name="body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <label class="col-md-10 m-0 fs-8 pb-1"> Research lines Involved: <label v-if="isiPublication1.researchLinesInvolved != null" class="fw-normal" style="font-size: 14px;">{{ isiPublication1.researchLinesInvolved }}</label><label v-else class="fw-normal" style="font-size: 14px;">---</label></label>
