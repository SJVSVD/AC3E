...
export default {
      ...
      reader.onload = (e) => {
        ...
        if (jsonData.length > 0) {
          ...
          const expectedHeaders = [
            "idUsuario", "Status", "No.", "Progress Report", "Co-autoria centro", "Author(s)",
            "Number of Research Line", "Article Title", "Journal Name", "Digital Object Identifier (DOI)",
            "Volume", "First page", "Last page", "Year Published", "Sending Date", "Acceptance Date",
            "State", "Funding", "Main Researchers", "Associative Researcher", "Postdoc.", "Thesis Students",
            "International External Researchers", "National External Researchers", "Q", "IF", "Comentario"
          ];
    ...
    async processFile() {
      if (this.excelData.length > 0) {
        try {
          const response = await axios.post('api/importIsi', {
            data: this.excelData
          });
