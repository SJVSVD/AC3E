            ...
            <div class="modal-wrapper">
              <div class="modal-container-xs">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="text" class= "form-control" v-model="empresa.rut" @keyup="checkRut()">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <slot name="footer">
                        <button class="btn btn-continue" @click="editarEmpresa()" :disabled="buttonDisable">
                            {{ buttonText }}
                        </button>
                    </slot>
                </div>
...
<script>
  ...
  export default {
    ...
    created(){
        ...
        this.getRegiones();
        this.getComunas();
        this.empresa.rut = this.empresa1.rut;
        this.empresa.razonSocial = this.empresa1.razonSocial;
        this.empresa.giro = this.empresa1.giro;
        this.empresa.direccion = this.empresa1.direccion;
        this.empresa.idPais = this.empresa1.idPais;
        this.empresa.idRegion = this.empresa1.idRegion;
        this.empresa.idComuna = this.empresa1.idComuna;
        this.empresa.telefono = this.empresa1.telefono;
        this.empresa.fax = this.empresa1.fax;
        this.empresa.codigoPostal = this.empresa1.codigoPostal;
        this.empresa.tipo = this.empresa1.tipo;

        this.id = this.empresa1.id;
    },
    methods: {
        checkRut() {
            if (this.empresa.rut != ''){
        ...
        getRegiones(){
            axios.get('../api/regiones').then( response =>{
                ...
                this.getRegionesSelect(this.empresa.idPais);
            }).catch(e=> console.log(e))
        },
        getComunas(){
            axios.get('../api/comunas').then( response =>{
                this.comunas = response.data;
                this.getComunasSelect(this.empresa.idRegion);
            }).catch(e=> console.log(e))
        },
        ...
        async editarEmpresa() {
            ...
            if (ok) {
                ...
                var id = this.id;
                axios.put(`../api/empresas/${id}`, empresa).then((result) => {
