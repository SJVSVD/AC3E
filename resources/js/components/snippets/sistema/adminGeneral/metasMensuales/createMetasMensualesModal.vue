          ...
          <div class="modal-wrapper">
            <div class="modal-container-s">
                  ...
                  <div class="row">
                    <div class="col-5">
                      <div class="form-group">
                        ...
                        <br>
                        <select class="form-select" v-model="metaMensual.idTienda">
                    ...
                    <div class="col-3">
                      <div class="form-group">
                        <label for="">Mes: </label>
                        <br>
                        <select class="form-select" v-model="metaMensual.mes">
                    ...
                    <div class="col-2">
                      <div class="form-group">
                        <label for="">Año: </label>
                        <br>
                        <select class="form-select" v-model="metaMensual.año">
                    ...
                    <div class="col-2">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_total"> 
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_carteras"> 
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_marroquineria"> 
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_calzado"> 
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_perfume"> 
                      </div>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class= "form-control" v-model="metaMensual.meta_vestimenta"> 
                      </div>
              ...
              <div class="modal-footer">
                  <slot name="footer">
                      <button class="btn btn-continue" @click="crearMetaMensual()" :disabled="buttonDisable">
                          {{ buttonText }}
                      </button>
                  </slot>
              </div>
...
export default {
    ...
    methods: {
      ...
      async crearMetaMensual() {
        const ok = await this.$refs.confirmation.show({
            title: 'Crear Meta Mensual',
            message: `¿Está seguro/a que desea crear esta meta mensual? Esta acción no puede ser desecha.`,            
            okButton: 'Crear',
            cancelButton: 'Volver'
        })
        if (ok) {
            let metaMensual = {
              idTienda: this.metaMensual.idTienda,
              meta_total: this.metaMensual.meta_total,
              meta_carteras: this.metaMensual.meta_carteras,
              meta_marroquineria: this.metaMensual.meta_marroquineria,
              meta_calzado: this.metaMensual.meta_calzado,
              meta_perfume: this.metaMensual.meta_perfume,
              meta_vestimenta: this.metaMensual.meta_vestimenta,
              año: this.metaMensual.año,
              mes: this.metaMensual.mes,
            }
            axios.post("../api/metasTienda", metaMensual).then((result) => {
                this.buttonDisable = true;
                this.buttonText = 'Guardando...';
                this.toast.success('Meta mensual creada con éxito!', {
                    position: "top-right",
                    timeout: 3000,
                    closeOnClick: true,
