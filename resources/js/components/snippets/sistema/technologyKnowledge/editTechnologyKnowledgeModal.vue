...
export default {
    ...
    created(){
      ...
      if (this.technology1.nameOfResearch != null) {
          const valoresSeparados1 = this.technology1.nameOfResearch.split(",");
          this.technologyKnowledge.nameOfResearch = valoresSeparados1.map((valor, index) => {
              valor = valor.trim();
              if (valor.endsWith('.')) {
