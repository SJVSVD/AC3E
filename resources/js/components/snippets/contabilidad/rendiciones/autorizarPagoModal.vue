                    ...
                    <table v-show="mostrarTablaAutorizar" class="table align-items-center mb-0" id="tableDesign">
                      ...
                      <tbody>
                        ...
                        <tr v-else v-for="rendi in rendisAutorizar" :key="rendi.id">
                          ...
                          <td>
                            <p class="text-sm mb-0">{{ formatMoneyCLP(rendi.montoRendi) }}</p>
                          </td>
                          <td>
                            <p class="text-sm mb-0">{{ formatMoneyCLP(rendi.montoSoli - rendi.montoRendi) }}</p>
                          </td>
                          <td>
                          ...
                          <td>
                            <p class="text-sm mb-0">{{ rendi.usuario_rendi.name }}</p>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="form-check">
                              <input style="-webkit-transform: scale(1.2); transform: scale(1.2);" type="radio" value="true" v-model="rendi.autorizadoPago">
                              <label style="margin-right:15px;">Si</label>
                              <input style="margin-left:15px; -webkit-transform: scale(1.2); transform: scale(1.2);" type="radio" value="false" v-model="rendi.autorizadoPago">
                              <label>No</label>
                              <input selected checked style="margin-left:15px; -webkit-transform: scale(1.2); transform: scale(1.2);" type="radio" value="null" v-model="rendi.autorizadoPago">
  ...
  methods: {
    ...
    getRendis(id){
      axios.get(`api/rendiciones/${id}`).then( response =>{
        ...
        this.rendisAutorizar = this.rendisAutorizar.filter(rendi => rendi.estado == "PendAutPag");
    ...
    async saveAuth() {
      if (this.rendisAutorizar == 0){
        ...
        if (ok) {
            ...
            axios.post('api/rendiciones/autorizarPago', $salida).then( response => {
