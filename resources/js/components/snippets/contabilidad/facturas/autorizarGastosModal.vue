                          ...
                          <td>
                            <div class="form-check">
                              <label v-if="factura.autorizador1.usuario.id == this.userID || is('Contabilidad_Jefatura')" class="form-check-label">
                                ...
                                <!-- <input style="-webkit-transform: scale(1.2); transform: scale(1.2);" :name="'autorizador'+factura.id" type="radio" value="true" v-model="factura.autorizadoAuth1">
                              ...
                              <label v-else class="form-check-label">
                                ...
                                <!-- <input style="-webkit-transform: scale(1.2); transform: scale(1.2);" :name="'autorizador'+factura.id" type="radio" value="true" v-model="factura.autorizadoAuth2">
                                <label style="margin-right:15px;">Si</label>
...
export default {
  ...
  created(){
    ...
    this.getFacturasAutorizables();
  },
  methods: {
    manipularFacturas(){
      if(this.selectedCompany == "Todas"){
        this.facturasAutorizar = this.facturasGastos;
      }
      else{
        this.facturasAutorizar = this.facturasGastos.filter((dato)=>dato.idEmpresa == this.selectedCompany);
      }
    },
    getEmpresas(){
    ...
    facturaDetalle(factura, accion){
      if(accion == "open"){
        ...
        document.getElementById('espaciadoTablaGastos').style.maxHeight = '300px';
      }
      if(accion == "close"){
        this.facturaDetalleIsVisible = false;
        this.facturaDetalles = [];
        document.getElementById('espaciadoTablaGastos').style.maxHeight = '500px';
      }
    },
    checkAll() {
