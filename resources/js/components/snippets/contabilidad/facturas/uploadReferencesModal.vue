              ...
              <div class="modal-body" style="height: 600px;">
                <slot name="body">
                  <div class="text-center" style="position: relative; top: 10%;">
                    <label style="font-size: 16px;" for="xls_file">Documento (.XLS o . XLSX) con las Referencias:</label><br>
                    <label style="color: #b80f0a; font-size: 11px; font-weight: normal;" for="xls_file">El sistema está diseñado para aceptar<label style="color: #b80f0a;">SOLAMENTE</label> el archivo de Facele.</label><br>
                    <form enctype="multipart/form-data">
                      ...
                      <a class="btn btn-danger btn-sm" @click="referencesImport()">Subir referencias</a>
                    </form>
