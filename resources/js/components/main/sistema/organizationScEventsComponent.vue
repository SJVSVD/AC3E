                ...
                <div class="row pb-0 p-4">
                    ...
                    <div class="col-lg-2 col-md-12 d-flex justify-content-lg-end justify-content-center align-items-center">
                        <div class="d-flex">
                            ...
                            <a class="btn btn-spacing btn-continue" id="show-modal1" @click="showNewOrganization = true">New Entry</a>
                                ...
                                <tbody>
                                    <tr v-for="organizationScEvent in organizationScEvents" :key="organizationScEvent.id">
                                        ...
                                        <td>
                                            ...
                                            <p v-if="organizationScEvent.status == 'Finished'" class="text-sm font-weight-bolder mb-0" style="color:#28A745">Registered</p>
                                        </td>                                          
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <p v-else class="text-sm mb-0">{{ this.thisDate(organizationScEvent.startDate) }}</p>
                                        </td>
                                        <td>
                                            <p v-if="organizationScEvent.endingDate == null" class="text-sm mb-0">---</p>
                                            <p v-else class="text-sm mb-0">{{ this.thisDate(organizationScEvent.endingDate) }}</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
