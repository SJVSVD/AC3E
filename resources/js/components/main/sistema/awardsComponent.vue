            ...
            <div class="card mb-4">
                <div class="row pb-0 p-4">
                    ...
                    <div class="col-lg-2 col-md-12 d-flex justify-content-lg-end justify-content-center align-items-center">
                        <div class="d-flex">
                            <a class="btn btn-spacing btn-continue" id="show-modal1" @click="showNewAward = true">New Entry</a>
                            &nbsp;
                                ...
                                <tbody>
                                    <tr v-for="award in awards" :key="award.id">
                                        ...
                                        <td>
                                            ...
                                            <p v-if="award.status == 'Finished'" class="text-sm font-weight-bolder mb-0" style="color:#28A745">Registered</p>
                                        </td>                                          
                                        <td>
