...
Route::group(['middleware' => 'auth'], function () {
	//Route::group(['middleware' => ['role:Colaborador']], function () {
		...
		Route::get('/performance-targets', [PageController::class, 'powerbiGoals'])->name('performance-targets');
		Route::get('/performance-results', [PageController::class, 'performanceResults'])->name('performance-results');
