...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('TIE_metasColaborador', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign("idVendedor")->references("id")->on("TIE_vendedores")->onDelete("cascade")->onUpdate("cascade");
    ...
    {
        Schema::dropIfExists('TIE_metasColaborador');
        Schema::table('TIE_metasColaborador', function (Blueprint $table) {
