...
class callAllDatabaseSeeders extends Seeder
{
    public function run()
    {
        $this->call([
            ...
            cierreCajasSeeder::class,
            facturasSeeder::class,
            fofisSeeder::class,
            inventariosSeeder::class,
            pagosSeeder::class,
            rendicionesSeeder::class,
            robosSeeder::class,
            detallesFofisSeeder::class,
            detallesRobosSeeder::class,
            contadorPersonasSeeder::class,
            metasColaboradorSeeder::class,
            metasDiariasSeeder::class,
            metasTiendaSeeder::class,
        ]);
    }
}
