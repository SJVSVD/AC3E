...
class correoNcvPendientes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'correoNcvPendientes';
     ...
     * @var string
     */
    protected $description = 'Correo para avisar a las tiendas que tienen notas de crédito pendientes';
    ...
    {
        $idSucursales = SYS_sucursales::pluck('id');
        
        
        foreach ($idSucursales as $idSucursal){
            $ncvsPendientes = TIE_NotasCredito::where('idTienda',$idSucursal)->where('motivo',null)->get();
            // Variables: 
            ...
            $tienda = SYS_sucursales::where('id',$idSucursal)->pluck('nombre');

            $output = null;
            foreach ($ncvsPendientes as $ncv) {
            ...
            $html = "<style>
                    ...
                    <h2> Las Notas de Crédito Pendientes son: </h2>
                    <h4> Enlace directo: </h4>
                    <a class='btn' href='".$domain."/ncv'>Ver Notas de Crédito</a>
                    <br>
            ...
            $emailData = json_encode([
                "GeneralData" => [
                    ...
                    "Message" => [
                    "Subject" => "Notas de Crédito Pendientes ".$tienda[0]." - Amphora",
                    "Classification" => "C",
                    "Body"=> [
                        "Format" => "html",
                        "Value" => $html
