...
class FacturasExport implements WithDefaultStyles, WithEvents, WithStyles, FromCollection, WithHeadings, WithProperties, ShouldAutoSize
{
    ...
    public function properties(): array
    {
        ...
        return [
            ...
            'title'          => 'Facturas',
            'description'    => 'TODAS las Facturas a la fecha, incluyendo campos ocultos en sistema.',
            'subject'        => 'Facturas',
