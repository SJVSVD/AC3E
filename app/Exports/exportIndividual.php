...
class exportIndividual implements WithMultipleSheets, WithDefaultStyles, WithEvents, WithStyles, FromCollection, WithHeadings, WithColumnWidths, WithProperties, WithTitle
{
    ...
    public function sheets(): array
    {
        ...
        $sheets['A2 NON WoS PUBLICATIONS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Authors','Article Title','Journal Name','Volume','First Page','Last Page','Funding','Year Published','Month','Main Researchers','Associative Researchers','Post Doc','Thesis Students','National External Researchers','International External Researchers','Comments'];
            }
        ...
        $sheets['A3 BOOKS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Books Authors','Chapter Authors','Title of the Book','Chapter Title','First Page','Last Page','Editorial/City/Country','Year','Month','Comments'];
            }
        ...
        $sheets['A4 AWARDS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
        ...
        $sheets['A5 ORGANIZATION OF SC EVENTS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
        ...
        $sheets['A6 PARTICIPATION OF SC EVENTS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress report','User','Researchers Involved','Type of event','Type of participation','Event name','Name of participants','Country','City','Start Date','Ending Date','Comments'];
            }
        ...
        $sheets['A7 VISITS AND STAYS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress report','User','Researchers Involved','Activity Name','Country Origin','City Origin','Country Destination','City Destination','Institution with which the Center collaborates','Beginning Date','Ending Date','Comments'];
            }
        ...
        $sheets['A8 THESES-STUDENTS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
        ...
        $sheets['A9 POSTDOCTORAL FELLOWS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Name of Postdoctoral Fellows','RUN/Passport','Gender','Research Topic','Tutor name','Associated Institution','Funding Source','Starting Date','Ending Date','Resources provided by the Center','Comments'];
            }
        ...
        $sheets['A10 OUTREACH'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Type of Activity','Event Title','Activity Description','Date','Attendant Amount','Duration (days)','Place Region','Undergraduate Students','Primary Education Students','Secondary Education Students','General Community','Companies,Industries,Services','School Teachers','Government Official','Other','Comments'];
            }
        ...
        $sheets['A11 PATENTS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','IP Type','Authors','Institution Owner(s)','Country of Registration','Application Date','Grant Date','Application Status','Registration Number','State','Comments'];
            }
        ...
        $sheets['A12 PUBLIC-PRIVATE CONECTIONS'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Name of Activity','Results/Goals','Name Of Organization','Country Origin','Start Date','Ending Date','Comments'];
            }
        ...
        $sheets['A13 TEC. AND KNOW. TRANSFER'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Technology Transfer','Knowledge Transfer','Type of Transfer','Country','City','Date','Comments'];
            }
        ...
        $sheets['A14 FUNDING SOURCES'] = new class ($idUsuarioDescarga) implements FromCollection, WithHeadings, WithTitle, WithDefaultStyles, WithEvents, WithStyles, WithColumnWidths {
            ...
            public function headings(): array
            {
                return ['Id', 'Progress Report','User','Researchers Involved','Researchers Involved','Type Sources','Name of the institution','Program/contest','Project Title','Principal Researcher','Start','Finish','In Cash','Type of collaboration','State','Comments'];
            }
